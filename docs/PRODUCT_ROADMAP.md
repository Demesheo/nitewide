...
| ~$25M–$50M growth case | Validate the reproducible Florida operating model: target 80 retained active nightclub venues plus one $5,000 ticket-only non-nightclub event per ten nightclub event-nights, ~$41.0M total face-value GMV, ~$4.0M gross platform revenue, reconciled positive contribution, durable venue/organizer/buyer/promoter cohorts, Premium usage, low concentration, and a repeatable national playbook. A $50M outcome still requires a premium ~12.5x strategic multiple or more scale; it is not inferred from one comparable. |
