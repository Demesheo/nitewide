...
- Use one transaction-fee schedule for both organization plans: the buyer pays 8% + $0.89 per paid order. Premium costs $249/month and provides no transaction-fee reduction. Do not add an organizer-side transaction fee or silently double-charge both sides.
...
- On a $20.00 one-ticket order, an 8% + $0.89 buyer fee is $2.49 and the card charge is $22.49 before tax. At the illustrative U.S. domestic online-card rate of 2.9% + $0.30, estimated processing is $0.95 on the full charge, leaving about $1.54 from the buyer fee before Connect, payout, refund, dispute, tax, support, promotion, and other costs. Reconcile actual cost from Stripe balance transactions rather than formula estimates.
