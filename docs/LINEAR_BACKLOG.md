...
| ECON-01 | P0 | 8 | Implement versioned buyer-funded pricing: the same 8% + $0.89 service fee per paid order for Free and $249/month Premium organizations, explicit fee display, no organizer-side or Premium-discounted transaction fee, configurable 10% service fee on organizer-funded promoter rewards, transparent gross/fee/net ledgers, refunds/reversals, and unit-economics telemetry. Never call an estimate the exact Stripe fee or report gross fees/subscriptions as net profit. |
