...
function installDemoStatic(app, root = path.resolve(__dirname, '../../../..')) {
  ...
  const page = name => {
    ...
    const notice = '<div role="status" style="padding:6px 12px;text-align:center;font:12px system-ui;background:#21192d;color:#e4d9f1">Public demo · Shared sample data · No real charges or admission · Use test contact details</div>';
