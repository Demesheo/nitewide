...
| ~$25M–$50M growth case | Validate the reproducible Florida operating model: target 80 retained active nightclub venues producing $500 of GA sales per event-night, plus one $5,000 ticket-only non-nightclub event per ten nightclub event-nights, ~$44.4M total face-value GMV, ~$4.4M gross platform revenue, reconciled positive contribution, durable venue/organizer/buyer/promoter cohorts, Premium usage, low concentration, and a repeatable national playbook. A $50M outcome still requires a premium ~11.3x strategic multiple or more scale; it is not inferred from one comparable. |
