...
| ~$25M–$50M growth case | Validate the reproducible Florida operating model: target 80 retained active nightclub venues producing $500 of GA sales per event-night, plus one $5,000 ticket-only non-nightclub event per ten nightclub event-nights, 50% promoter/affiliate-attributed transactions, ~$44.4M total face-value GMV, ~$4.8M gross platform revenue including privacy-safe contextual ads and aggregated insights, reconciled positive contribution, durable venue/organizer/buyer/promoter cohorts, Premium usage, low concentration, and a repeatable national playbook. A $50M outcome still requires a premium ~10.5x strategic multiple or more scale; it is not inferred from one comparable. |
