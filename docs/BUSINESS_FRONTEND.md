...
5. Select a guestlist event/status, open a request, and check that permitted review actions and allocation controls remain reachable. Do not approve/decline real requests merely to test layout.
