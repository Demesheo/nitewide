...
function initNotification(sequelize) {
  Notification.init({ id: id(), userId: { type: DataTypes.UUID, allowNull: false }, eventId: DataTypes.UUID,
    ...
    message: { type: DataTypes.STRING(500), allowNull: false }, metadata: { type: DataTypes.JSONB, allowNull: false, defaultValue: {} }, readAt: DataTypes.DATE, dismissedAt: DataTypes.DATE,
