...
The buyer-facing service fee is Nitewide platform revenue; it does not represent or reimburse the host's Stripe processing cost. Checkout must show the ticket subtotal, Nitewide service fee, taxes, discounts/credits, and final customer total before payment. The host's actual Stripe processing fee is recorded separately in settlement and business reporting and is never added as a second customer surcharge.

- Use one transaction-fee schedule for both organization plans: the buyer pays 7.5% + $0.79 per paid order. Premium costs $249/month and provides no transaction-fee reduction. Do not add an organizer-side Nitewide transaction fee or silently double-charge both sides.
...
- On a $20.00 one-ticket order, a 7.5% + $0.79 buyer fee is $2.29 and the customer charge is $22.29 before tax. At the illustrative Stripe U.S. domestic online-card rate of 2.9% + $0.30, estimated processing is $0.95 on the full charge and belongs to the host. Nitewide's gross service-fee revenue is $2.29 before its own refunds, disputes, Connect/platform costs, tax, support, promotion, and other expenses. Reconcile the host's actual cost from Stripe balance transactions rather than formula estimates.
- Report the connected venue's Stripe processing cost and Nitewide's application-fee revenue separately; do not describe Nitewide's gross application fee as net cash flow. The ledger must make the responsible party explicit for every charge.
...
- Example: a $5.00 gross promoter reward produces a $0.50 Nitewide affiliate fee and a $4.50 promoter reward before disclosed adjustments. On the $20.00 attributed sale above, Nitewide records $2.79 in gross service-fee revenue: $2.29 buyer service fee plus $0.50 affiliate service fee. The host's actual Stripe processing expense remains separate; refunds, disputes, reversals, taxes, support, and other platform costs can reduce Nitewide's recognized revenue or contribution.
